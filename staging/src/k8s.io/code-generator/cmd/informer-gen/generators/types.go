...
var (
	...
	cacheGenericLister          = types.Name{Package: "github.com/hyperhq/client-go/tools/cache", Name: "GenericLister"}
	cacheIndexers               = types.Name{Package: "github.com/hyperhq/client-go/tools/cache", Name: "Indexers"}
	cacheListWatch              = types.Name{Package: "github.com/hyperhq/client-go/tools/cache", Name: "ListWatch"}
	cacheMetaNamespaceIndexFunc = types.Name{Package: "github.com/hyperhq/client-go/tools/cache", Name: "MetaNamespaceIndexFunc"}
	cacheNamespaceIndex         = types.Name{Package: "github.com/hyperhq/client-go/tools/cache", Name: "NamespaceIndex"}
	cacheNewGenericLister       = types.Name{Package: "github.com/hyperhq/client-go/tools/cache", Name: "NewGenericLister"}
	cacheNewSharedIndexInformer = types.Name{Package: "github.com/hyperhq/client-go/tools/cache", Name: "NewSharedIndexInformer"}
	cacheSharedIndexInformer    = types.Name{Package: "github.com/hyperhq/client-go/tools/cache", Name: "SharedIndexInformer"}
